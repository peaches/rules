module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c130 = "break",
        peg$c131 = { type: "literal", value: "break", description: "\"break\"" },
        peg$c132 = "continue",
        peg$c133 = { type: "literal", value: "continue", description: "\"continue\"" },
        peg$c134 = "do",
        peg$c135 = { type: "literal", value: "do", description: "\"do\"" },
        peg$c136 = "else",
        ...
        peg$c142 = "func",
        peg$c143 = { type: "literal", value: "func", description: "\"func\"" },
        peg$c144 = "get",
        peg$c145 = { type: "literal", value: "get", description: "\"get\"" },
        peg$c146 = "if",
        ...
        peg$c162 = "while",
        peg$c163 = { type: "literal", value: "while", description: "\"while\"" },
        peg$c164 = ";",
        peg$c165 = { type: "literal", value: ";", description: "\";\"" },
        peg$c166 = "}",
        peg$c167 = { type: "literal", value: "}", description: "\"}\"" },
        peg$c168 = function() { return { type: "ThisExpression" }; },
        peg$c169 = "(",
        ...
        peg$c178 = function(elision) {
              return {
                type:     "ArrayExpression",
                elements: optionalList(extractOptional(elision, 0))
              };
            },
        peg$c179 = function(elements) {
              return {
                type:     "ArrayExpression",
                elements: elements
              };
        ...
        peg$c182 = function(elements, elision) {
              return {
                type:     "ArrayExpression",
                elements: elements.concat(optionalList(extractOptional(elision, 0)))
              };
            },
        peg$c183 = function(elision, element) {
                return optionalList(extractOptional(elision, 0)).concat(element);
              },
        peg$c184 = function(first, rest) { return Array.prototype.concat.apply(first, rest); },
        peg$c185 = function(commas) { return filledArray(commas.length + 1, null); },
        peg$c186 = "{",
        peg$c187 = { type: "literal", value: "{", description: "\"{\"" },
        peg$c188 = function() { return { type: "ObjectExpression", properties: [] }; },
        peg$c189 = function(properties) {
        ...
        peg$c193 = function(key, value) {
              return { key: key, value: value, kind: "init" };
            },
        peg$c194 = function(key, body) {
              return {
                key:   key,
                value: {
        ...
        peg$c195 = function(key, params, body) {
              return {
                key:   key,
                value: {
                  type:   "FunctionExpression",
        ...
        peg$c196 = function(id) { return [id]; },
        peg$c197 = function(property) {
                  return { property: property, computed: true };
                },
        peg$c198 = function(property) {
        ...
        peg$c205 = function(args) {
              return optionalList(extractOptional(args, 0));
            },
        peg$c206 = function(operator, argument) {
              return {
        ...
        peg$c209 = function(first, rest) { return buildBinaryExpression(first, rest); },
        peg$c210 = "*",
        ...
        peg$c249 = function(first, rest) { return buildList(first, rest, 1); },
        peg$c250 = function() { return { type: "EmptyStatement" }; },
        ...
        peg$c252 = function(test, consequent, alternate) {
              return {
                type:       "IfStatement",
                test:       test,
        ...
        peg$c254 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test }; },
        peg$c255 = function(test, body) { return { type: "WhileStatement", test: test, body: body }; },
        peg$c256 = function(init, test, update, body) {
              return {
                type:   "ForStatement",
        ...
        peg$c264 = function(id, params, body) {
              return {
                type:   "FunctionExpression",
